...
export const DEVICE_ANSWERS: Record<string, string> = {
  pc: "PC",
  laptop: "Laptop",
};

export const USAGE_ANSWERS: Record<string, string> = {
...
export const RESPONSES: Record<string, Record<string, Result>> = {
  pc: {
    "video-editor": {
